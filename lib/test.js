...
/**
 * Applies a middleware to a Test.
 *
 * @param {Middleware} a middleware function that accepts a Test to mutate
 * @returns {Test} this test
 * @api public
 */

Test.prototype.use = function(middleware) {
  middleware(this);
  return this;
}
